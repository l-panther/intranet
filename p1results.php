...
if(isSession("adminName")) { # If admin name exist in global array, show content.
    ...
    $module = "Web Programming using PHP"; # Module name.
	echo '
				<section class="account-main"> 
			';
    include 'includes/breadcrumbs.php'; # Display breadcrumb.
    include 'includes/p1results.php'; # Display PHP results.
    echo '      
            	</section> <!-- End section -->
              </main> <!-- End main -->
        </div> <!-- End page -->
...
';
	...
	echo '
			...
			';
    include 'includes/breadcrumbs.php'; # Display breadcrumb.
    include 'includes/p1results.php'; # Display Problem Solving results.
    echo '      
            	</section> <!-- End section -->
        	</main> <!-- End main -->
        </div> <!-- End page -->
