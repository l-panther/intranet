                ...
                <form role="form" id="adminform" action="' . $adminself . '" method="post">
                    <fieldset id="fieldset_admin">
						...
						<div class="w3-row w3-section">
							...
							<div class="w3-rest">
							  <input aria-required="true" required="required" class="w3-input" value="' . $adminName . '" name="adminName" type="text" id="adminName" placeholder="Username">
						...
						<div class="w3-row w3-section">
							...
							<div class="w3-rest">
							  <input aria-required="true" required="required" class="w3-input" value="' . $adminPassword . '" name="adminPassword" type="password" id="adminPassword" placeholder="Password">
