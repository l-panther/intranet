				<nav role="navigation" class="w3-sidenav w3-collaspe w3-hide-large w3-hide-large w3-animate-left">
					<ul>
						...
						<li>Staff<i class="fa fa-chevron-right"></i></li>
						...
						<li>Messgaes<span class="menu-icon menu-icon-staff-messages">16</span></li>
